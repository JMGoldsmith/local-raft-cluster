...
resource "docker_network" "raft_network" {
  name       = "raft-network"
  attachable = true
  ipam_config { subnet = var.network_cidr != "" ? var.network_cidr : "10.42.0.0/16" }
}
...
resource "docker_container" "vault" {
  ...
  upload {
    content = "/Users/johngoldsmith/code/replication_envs/mine/cluster/plugins/vault-plugin-secrets-github-linux-amd64-1-30"

    file = "/home/vault/plugins/vault-plugin-secrets-github-linux-amd64-1-30"
  }

  upload {
    content = "/Users/johngoldsmith/code/replication_envs/mine/cluster/plugins/vault-plugin-secrets-github-linux-amd64-2"

    file = "/home/vault/plugins/vault-plugin-secrets-github-linux-amd64-2"
  }
